...
const Header = () => {
  return (
    <header className="flex fixed z-10 w-screen bg-[#F8F8F8] h-[56px] top-0 left-0 border-solid border-t-[3px] border-[#ef8236] shadow-md text-[13px] text-nav-color font-normal">
      <div className="flex items-center justify-center w-[1265px] h-[52.8px] max-w-[1265px] mx-auto">
        {/* <Link to="/">  */}
        <a className='h-[100%] flex items-center px-[8px] hover:bg-[#E1E3E5]'>
          <img className='min-w-[164px] w-[150px] h-[30px]  text-white' src={StackoverFlowLogo} alt="Stack Overflow Logo" />
        </a>
          
        {/* </Link>  */} 
          <ol className="flex /* justify-between items-center */ w-[234px] gap-[4px] p-[2px}">
